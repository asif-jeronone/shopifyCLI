...
Route::get('/api/auth/callback', function (Request $request) {
    ...
    $productUpdate = Registry::register('/api/webhooks', Topics::PRODUCTS_UPDATE, $shop, $session->getAccessToken());
    $productCreate = Registry::register('/api/webhooks', Topics::PRODUCTS_CREATE, $shop, $session->getAccessToken());
